"use strict";
(self["webpackChunk_lenna_project_lenna_web"] = self["webpackChunk_lenna_project_lenna_web"] || []).push([[272],{
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0]!./src/views/Home.vue?vue&type=template&id=05d911a5&scoped=true


(0,runtime_dom_esm_bundler_js_.pushScopeId)("data-v-05d911a5")
const Homevue_type_template_id_05d911a5_scoped_true_hoisted_1 = /*#__PURE__*/(0,runtime_dom_esm_bundler_js_.createElementVNode)("br", null, null, -1)
const Homevue_type_template_id_05d911a5_scoped_true_hoisted_2 = { class: "main" }
const Homevue_type_template_id_05d911a5_scoped_true_hoisted_3 = /*#__PURE__*/(0,runtime_dom_esm_bundler_js_.createElementVNode)("h1", null, "Convert images online without upload of your data", -1)
const Homevue_type_template_id_05d911a5_scoped_true_hoisted_4 = { key: 0 }
const Homevue_type_template_id_05d911a5_scoped_true_hoisted_5 = { class: "top_main" }
...
function Homevue_type_template_id_05d911a5_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ((0,runtime_dom_esm_bundler_js_.openBlock)(), (0,runtime_dom_esm_bundler_js_.createElementBlock)("div", null, [
    (0,runtime_dom_esm_bundler_js_.createVNode)(_component_Slide, null, {
      default: (0,runtime_dom_esm_bundler_js_.withCtx)(() => [
        ...
        Homevue_type_template_id_05d911a5_scoped_true_hoisted_1,
        (_ctx.pluginsManager)
    ...
    (0,runtime_dom_esm_bundler_js_.createElementVNode)("div", Homevue_type_template_id_05d911a5_scoped_true_hoisted_2, [
      Homevue_type_template_id_05d911a5_scoped_true_hoisted_3,
      (_ctx.just)
        ? ((0,runtime_dom_esm_bundler_js_.openBlock)(), (0,runtime_dom_esm_bundler_js_.createElementBlock)("h2", Homevue_type_template_id_05d911a5_scoped_true_hoisted_4, (0,runtime_dom_esm_bundler_js_.toDisplayString)(_ctx.just), 1))
        : (0,runtime_dom_esm_bundler_js_.createCommentVNode)("", true),
      (0,runtime_dom_esm_bundler_js_.createElementVNode)("div", Homevue_type_template_id_05d911a5_scoped_true_hoisted_5, [
      ...
      (0,runtime_dom_esm_bundler_js_.createElementVNode)("div", _hoisted_7, [
        ...
        }, null, 8, ["pluginManager", "defaultConfig", "defaultPlugins"])
      ]),
...
;// CONCATENATED MODULE: ./src/views/Home.vue?vue&type=template&id=05d911a5&scoped=true
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0]!./src/components/PluginsManager.vue?vue&type=template&id=76653343&scoped=true


(0,runtime_dom_esm_bundler_js_.pushScopeId)("data-v-76653343")
const PluginsManagervue_type_template_id_76653343_scoped_true_hoisted_1 = { class: "plugins-manager" }
;(0,runtime_dom_esm_bundler_js_.popScopeId)()

function PluginsManagervue_type_template_id_76653343_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ((0,runtime_dom_esm_bundler_js_.openBlock)(), (0,runtime_dom_esm_bundler_js_.createElementBlock)("div", PluginsManagervue_type_template_id_76653343_scoped_true_hoisted_1, [
...
;// CONCATENATED MODULE: ./src/components/PluginsManager.vue?vue&type=template&id=76653343&scoped=true
...
;
PluginsManagervue_type_script_lang_ts.render = PluginsManagervue_type_template_id_76653343_scoped_true_render
PluginsManagervue_type_script_lang_ts.__scopeId = "data-v-76653343"
...
;// CONCATENATED MODULE: ./src/controllers/plugin_manager.ts
...
class PluginManager {
    ...
    async importModule(key, url, module) {
    ...
    changeConfig(name, config) {
        const plugin = this.plugins.find((o) => o.name === name);
        if (plugin) {
            plugin.config = config;
        }
    }
...
;// CONCATENATED MODULE: ./src/controllers/processor.ts
const processImages = async (sourceImages, resultImages, plugins, logger, progressCallback) => {
    ...
    for (const sourceImage of sourceImages) {
        tasks.push(processImage(sourceImage, plugins, progressCallback).then((image) => {
            const file = new File([image], sourceImage.name, {
                type: "image/png",
            });
            resultImages.push(file);
            convertedCount++;
            logger.success(`converted ${convertedCount} of ${imageCount} images`);
        }));
    }
...
const processImage = async (imageFile, plugins, progressCallback) => {
    let progress = 0.0;
...
/* harmony default export */ const Homevue_type_script_lang_ts = ((0,runtime_dom_esm_bundler_js_.defineComponent)({
    ...
    methods: {
        ...
        async processImages() {
            ...
            nprogress.start();
            const toast = (0,esm/* useToast */.pm)();
            await processImages(this.sourceImages, this.resultImages, this.pluginManager.getPlugins(), {
                info: (message) => {
                    toast.info(message);
                },
                success: (message) => {
...
;
Homevue_type_script_lang_ts.render = Homevue_type_template_id_05d911a5_scoped_true_render
Homevue_type_script_lang_ts.__scopeId = "data-v-05d911a5"

/* harmony default export */ const Home = (Homevue_type_script_lang_ts);
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0]!./src/views/About.vue?vue&type=template&id=53080255&scoped=true


(0,runtime_dom_esm_bundler_js_.pushScopeId)("data-v-53080255")
const Aboutvue_type_template_id_53080255_scoped_true_hoisted_1 = { class: "about" }
const Aboutvue_type_template_id_53080255_scoped_true_hoisted_2 = /*#__PURE__*/(0,runtime_dom_esm_bundler_js_.createElementVNode)("h1", null, "About Lenna Project", -1)
const Aboutvue_type_template_id_53080255_scoped_true_hoisted_3 = /*#__PURE__*/(0,runtime_dom_esm_bundler_js_.createElementVNode)("p", null, " Lenna is a library for image processing algorithms. The web page allows to test and use them. ", -1)
const Aboutvue_type_template_id_53080255_scoped_true_hoisted_4 = /*#__PURE__*/(0,runtime_dom_esm_bundler_js_.createStaticVNode)("<h2 data-v-53080255>Thanks</h2><ul data-v-53080255><li data-v-53080255>Silvia (<a href=\"https://github.com/silvia-odwyer/photon\" data-v-53080255>photon</a>)</li></ul><h2 data-v-53080255>Plugins</h2><p data-v-53080255> Lenna allows to plug in more algorithms. The plugins can be activated for use in the <a href=\"https://lenna.app/marketplace/\" data-v-53080255>marketplace</a>. Some examples can be found at <a href=\"https://github.com/lenna-project/lenna-plugins\" data-v-53080255>lenna-project/lenna-plugins</a> on github. <br data-v-53080255> Following a list of available plugins: <ul data-v-53080255><li data-v-53080255><b data-v-53080255>blur</b> - Blurs the image. The strength can be configured.</li><li data-v-53080255><b data-v-53080255>dramatic</b> - Gives the image a dramatic touch.</li><li data-v-53080255><b data-v-53080255>exif</b> - Allows to clear exif data of the image.</li><li data-v-53080255><b data-v-53080255>rotate</b> - Rotates the image.</li><li data-v-53080255><b data-v-53080255>canny</b> - Shows edges of objects in the image.</li></ul></p><h2 data-v-53080255>Jupyter Notebooks</h2> View some notebooks <a href=\"/jupyter\" data-v-53080255>here</a> to see how the plugins can be used in python. <h2 data-v-53080255>Command Line Interface</h2>", 9)
...
function Aboutvue_type_template_id_53080255_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Help = (0,runtime_dom_esm_bundler_js_.resolveComponent)("Help")

  return ((0,runtime_dom_esm_bundler_js_.openBlock)(), (0,runtime_dom_esm_bundler_js_.createElementBlock)("div", Aboutvue_type_template_id_53080255_scoped_true_hoisted_1, [
    Aboutvue_type_template_id_53080255_scoped_true_hoisted_2,
    Aboutvue_type_template_id_53080255_scoped_true_hoisted_3,
    (0,runtime_dom_esm_bundler_js_.createVNode)(_component_Help),
    Aboutvue_type_template_id_53080255_scoped_true_hoisted_4,
    _hoisted_13,
    _hoisted_14,
    _hoisted_15,
    _hoisted_16,
...
;// CONCATENATED MODULE: ./src/views/About.vue?vue&type=template&id=53080255&scoped=true
...
;
Aboutvue_type_script_lang_ts.render = Aboutvue_type_template_id_53080255_scoped_true_render
Aboutvue_type_script_lang_ts.__scopeId = "data-v-53080255"
